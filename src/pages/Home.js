    ...
    <div className='container mx-auto'>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <motion.div initial={{ opacity: 0, y: '-50%' }} 
                    ...
                    className='w-full pt-36 pb-14 lg:pt-0 lg:pg-0 lg:w-auto z-10 lg:absolute flex flex-col justify-center items-center lg:items-start'>
        ...
        <div className='flex justify-end max-h-96 lg:max-h-max'>
          <motion.div initial={{ scale: 0 }} 
                      animate={{ scale: 1 }} 
                      exit={{ scale: 0 }} 
                      transition={ transition1 } className='relative lg:-right-40 overflow-hidden'>
